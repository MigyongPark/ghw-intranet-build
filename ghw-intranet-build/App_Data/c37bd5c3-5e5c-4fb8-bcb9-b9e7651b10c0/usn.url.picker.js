angular.module('umbraco').controller('UsnUrlPickerController', function ($scope, dialogService, entityResource) {
...
angular.module('umbraco').controller('USNUrlPickerDefaultTypeController', function($scope) {
